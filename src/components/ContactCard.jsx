...
const StyledDiv = styled.div`
    ...
    border-radius: 8px;
    box-shadow: ${(props) =>
        props.isLandlord ? "none" : "0px 5px 10px 0px rgba(0, 0, 0, 0.2)"};
    right: calc(20%);
    display: flex;
...
const ContactCard = ({ role, userId, propertyId, handleClick }) => {
        ...
        <StyledDiv isLandlord={role === "landlord"}>
            {currentId ? (
                ...
                <div className="flex flex-column gap-md">
                    ...
                    <Button variant="Primary" size="def" onClick={handleClick}>
                        Login
                    </Button>
                </div>
            )}
