        ...
        <Section>
          ...
          <DivRow>
            ...
            <div className="flex flex-column a-end gap-sm">
              ...
              <ProDetails>+ {property?.maintenance_price}</ProDetails>
            </div>
          </DivRow>
          <DivDetails>
            <div className="flex a-center j-center">
              <ProDetails2>
                <BiBed style={{ fontSize: "32px" }} /> {property?.bedrooms}{" "}
                bedrooms
              </ProDetails2>
            </div>
            <div className="flex">
              <ProDetails2>
                <BiBath style={{ fontSize: "32px" }} /> {property?.bathrooms}{" "}
                bathrooms
              </ProDetails2>
            </div>
            <div className="flex">
              <ProDetails2>
                <BiArea style={{ fontSize: "32px" }} /> {property?.area} m2
              </ProDetails2>
            </div>
            <div className="flex">
              <ProDetails2>
                <MdPets style={{ fontSize: "32px" }} />{" "}
                {property?.pet_friendly ? "Pets allowed" : "No pets allowed"}
              </ProDetails2>
            </div>
          </DivDetails>
          <DivCol>
