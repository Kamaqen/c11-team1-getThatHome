...
//       const bedroomsMatch =
//         !filter.bedrooms || item.bedrooms === parseInt(filter.bedrooms);
//       const bathroomsMatch =
//         !filter.bathrooms || item.bathrooms === parseInt(filter.bathrooms);
//       const petFriendlyMatch =
//         !filter.pet_friendly || item.pet_friendly === filter.pet_friendly;

//       const areaInRange =
//         !filter.area ||
//         ((!filter.area.min || item.area >= parseInt(filter.area.min)) &&
//           (!filter.area.max || item.area <= parseInt(filter.area.max)));
